...
function initGraph() {
    ...
    width = $(".graphArea").outerWidth();
    height = $(".graphArea").outerHeight();
    ...
    d3.json("js/indicatorsEX.json", function (error, data) {
     ...
     //               .style("transform","translate('"+aaa+"'px,'"+math.random+"'px)")
     //               .each("end", function () { if (this.__transition__.count < 1) loop(); });
     //       })();
     //   }
